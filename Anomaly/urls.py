...
from Advanced_Intrusion import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Advanced_Intrusion_Type/$', remoteuser.Predict_Advanced_Intrusion_Type, name="Predict_Advanced_Intrusion_Type"),
    ...
    url(r'^View_Predicted_Advanced_Intrusion_Type_Ratio/$', serviceprovider.View_Predicted_Advanced_Intrusion_Type_Ratio, name="View_Predicted_Advanced_Intrusion_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Advanced_Intrusion_Type_Details/$', serviceprovider.View_Predicted_Advanced_Intrusion_Type_Details, name="View_Predicted_Advanced_Intrusion_Type_Details"),
